...
namespace TestLayer
{
    ...
    public class SubmitJokeResponseTest_UnhappyPath
    {
        ...
        [Test]
        public void GivenAnInvalidJoke_AdditionalInfoIsCorrect()
        {
            Assert.That(_sjs.JsonResponse["additionalInfo"].ToString(), Is.EqualTo("Request body is empty or request timed out."));
        }
